...
-- 管理员看全部
DROP POLICY IF EXISTS "wallet_balance_admin_full" ON public.wallet_balance;
...
DROP POLICY IF EXISTS "wallet_tx_select_own" ON public.wallet_tx;


CREATE POLICY "wallet_tx_select_own" ON public.wallet_tx
  FOR SELECT TO authenticated USING (user_id = auth.uid());

DROP POLICY IF EXISTS "wallet_tx_admin_full" ON public.wallet_tx;
...
DROP POLICY IF EXISTS "episodes_owner_full" ON public.episodes;
...
DROP POLICY IF EXISTS "episodes_admin_full" ON public.episodes;
...
DROP POLICY IF EXISTS "episode_unlocks_admin_full" ON public.episode_unlocks;
...
DROP POLICY IF EXISTS "series_purchases_admin_full" ON public.series_purchases;
...
DROP POLICY IF EXISTS "ucoins_orders_select_own" ON public.ucoins_orders;


CREATE POLICY "ucoins_orders_select_own" ON public.ucoins_orders
  FOR SELECT TO authenticated USING (user_id = auth.uid());

DROP POLICY IF EXISTS "ucoins_orders_admin_full" ON public.ucoins_orders;
